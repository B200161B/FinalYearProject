...
<body>
      ...
      $sql1 ="SELECT name,unitPrice,picture,id from product WHERE category ='$category'";
    ...
    <div class="row no-gutters">
        ...
        <div class="col">
            <div class="card-body">
                ...
                <a  class="btn btn-primary stretched-link" href="product_info.php?productid=<?php echo ($result->id)?>">View</a>
            </div>
        </div>
    </div>
</div>
